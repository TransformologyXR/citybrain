# MAIN-CITYBRAIN-D12-STANDING-CAPABILITY-REGRESSION-R1

Run standing regression after data/runtime changes:
- held-out ASK
...
Deliverable: `D12_STANDING_CAPABILITY_REGRESSION_REPORT.json`.
