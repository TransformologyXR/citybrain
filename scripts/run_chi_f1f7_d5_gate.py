...
from txr_citybrain_chi_f1f7_d5_accepted_snapshot import (
    DEFAULT_D1B_DIR,
    DEFAULT_D2B_DIR,
    DEFAULT_D3B_DIR,
    ...
    DEFAULT_F7B_DIR,
    DEFAULT_OUTPUT_DIR,
    run_chi_f1f7_d5_gate,
)


def main() -> int:
    parser = argparse.ArgumentParser(description="Run CHI-F1F7-D5 Chicago dual-flow accepted snapshot gate.")
