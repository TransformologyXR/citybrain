...
from txr_citybrain_lon_hero_dual_scenario_package import run_lon_hero_gate


def main() -> int:
    parser = argparse.ArgumentParser(description="Run LON-HERO dual scenario gate")
    ...
    parser.add_argument("--output-dir", default="outputs/lon_hero_dual_scenario_package")
    ...
    report = run_lon_hero_gate(
        d13c_dir=args.d13c_dir,
        d6b4_dir=args.d6b4_dir,
        d11c_dir=args.d11c_dir,
        d11a_dir=args.d11a_dir,
        d10ev_dir=args.d10ev_dir,
        d12b_dir=args.d12b_dir,
        d10b_dir=args.d10b_dir,
        d10z_dir=args.d10z_dir,
        d9z_dir=args.d9z_dir,
        mission_control_html=args.mission_control,
        todo_html=args.todo,
        output_dir=args.output_dir,
        live_face_base_url=args.live_face_base_url,
        live_nim_endpoint=args.live_nim_endpoint,
        live_nim_model=args.live_nim_model,
