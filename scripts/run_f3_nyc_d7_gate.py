...
from txr_citybrain_f3_nyc_d7_live_face_layer_route_map_trace import (
    DEFAULT_BASE_URL,
    DEFAULT_D2_DIR,
    DEFAULT_D2C_DIR,
    DEFAULT_D3_DIR,
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run F3-NYC-D7 live face-layer gate")
    ...
    print(f"F3-NYC-D7: {report['status']}")
