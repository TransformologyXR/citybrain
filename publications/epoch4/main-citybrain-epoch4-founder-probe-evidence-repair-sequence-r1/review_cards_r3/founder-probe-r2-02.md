# Founder Probe Review Card R3: founder-probe-r2-02

## Task Identity

- Task id: `founder-probe-r2-02`
- Family: `building_compliance_perception_candidate`
- Scenario: `negative_no_data`
- Eval case: `eval-r2:building_compliance_perception_candidate:negative_no_data`
...
```json
{
  ...
  "challenge_boundary_evidence": {
    "case_id": "eval-r2:building_compliance_perception_candidate:negative_no_data",
