# Founder Probe Review Card R3: founder-probe-r2-04

## Task Identity

- Task id: `founder-probe-r2-04`
- Family: `building_compliance_perception_candidate`
- Scenario: `contradiction_pair`
- Eval case: `eval-r2:building_compliance_perception_candidate:contradiction_pair`
...
```json
{
  ...
  "challenge_boundary_evidence": {
    "case_id": "eval-r2:building_compliance_perception_candidate:contradiction_pair",
