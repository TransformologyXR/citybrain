# Founder Probe Review Card R3: founder-probe-r2-01

## Task Identity

- Task id: `founder-probe-r2-01`
- Family: `building_compliance_perception_candidate`
- Scenario: `positive_packet_baseline`
- Eval case: `eval-r2:building_compliance_perception_candidate:positive_packet_baseline`
