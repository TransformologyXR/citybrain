# Founder Probe Review Card R3: founder-probe-r2-15

## Task Identity

- Task id: `founder-probe-r2-15`
- Family: `permit_inspection_delay`
- Scenario: `stale_freshness`
- Eval case: `eval-r2:permit_inspection_delay:stale_freshness`
...
```json
{
  ...
  "challenge_boundary_evidence": {
    "case_id": "eval-r2:permit_inspection_delay:stale_freshness",
