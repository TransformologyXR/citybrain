# Founder Probe Review Card R3: founder-probe-r2-08

## Task Identity

- Task id: `founder-probe-r2-08`
- Family: `city_asset_infrastructure_issue`
- Scenario: `contradiction_pair`
- Eval case: `eval-r2:city_asset_infrastructure_issue:contradiction_pair`
...
```json
{
  ...
  "challenge_boundary_evidence": {
    "case_id": "eval-r2:city_asset_infrastructure_issue:contradiction_pair",
