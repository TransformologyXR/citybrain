# Founder Probe Review Card R3: founder-probe-r2-13

## Task Identity

- Task id: `founder-probe-r2-13`
- Family: `permit_inspection_delay`
- Scenario: `positive_packet_baseline`
- Eval case: `eval-r2:permit_inspection_delay:positive_packet_baseline`
