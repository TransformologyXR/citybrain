# Founder Probe Review Card R3: founder-probe-r2-07

## Task Identity

- Task id: `founder-probe-r2-07`
- Family: `city_asset_infrastructure_issue`
- Scenario: `stale_freshness`
- Eval case: `eval-r2:city_asset_infrastructure_issue:stale_freshness`
...
```json
{
  ...
  "challenge_boundary_evidence": {
    "case_id": "eval-r2:city_asset_infrastructure_issue:stale_freshness",
