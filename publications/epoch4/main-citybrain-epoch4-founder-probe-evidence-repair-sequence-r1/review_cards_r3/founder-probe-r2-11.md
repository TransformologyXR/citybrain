# Founder Probe Review Card R3: founder-probe-r2-11

## Task Identity

- Task id: `founder-probe-r2-11`
- Family: `mobility_access_interruption_v0`
- Scenario: `stale_freshness`
- Eval case: `eval-r2:mobility_access_interruption_v0:stale_freshness`
...
```json
{
  ...
  "challenge_boundary_evidence": {
    "case_id": "eval-r2:mobility_access_interruption_v0:stale_freshness",
