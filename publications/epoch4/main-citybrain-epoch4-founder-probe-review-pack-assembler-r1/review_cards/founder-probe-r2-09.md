# Founder Probe Review Card: founder-probe-r2-09

## Task Identity

- Task id: `founder-probe-r2-09`
- Family: `mobility_access_interruption_v0`
- Scenario: `positive_packet_baseline`
- Eval case: `eval-r2:mobility_access_interruption_v0:positive_packet_baseline`
...
```json
{
  ...
  "check_ref": "check:v1:mobility_access_interrup
  ... truncated
}
```
