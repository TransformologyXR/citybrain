# founder-probe-r2-03 - building_compliance_perception_candidate

- Scenario: `stale_freshness`
- Readiness: `founder_diagnostic_ready`
- Weakness classification: `intentional diagnostic negative/stale/contradiction behavior`
- Provenance: `native_or_replay_review_evidence`
- Expected CHECK outcome: `downgrade_freshness`
- Actual CHECK outcome: `PASS_LIMITED_OR_ABSTAIN`
