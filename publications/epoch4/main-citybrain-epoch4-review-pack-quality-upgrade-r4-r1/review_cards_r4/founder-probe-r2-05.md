# founder-probe-r2-05 - city_asset_infrastructure_issue

- Scenario: `positive_packet_baseline`
- Readiness: `founder_product_review_ready`
- Weakness classification: `card-quality gap`
- Provenance: `native_or_replay_review_evidence`
- Expected CHECK outcome: `sufficient_for_review`
- Actual CHECK outcome: `sufficient_for_review`
