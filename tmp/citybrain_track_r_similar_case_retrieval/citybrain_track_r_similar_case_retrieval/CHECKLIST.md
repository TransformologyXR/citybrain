...
- Confirm similar cases are context, not proof.
- Confirm provenance and limitations are preserved for every case.
- Confirm retrieval quality gate includes negative/overclaim cases.
