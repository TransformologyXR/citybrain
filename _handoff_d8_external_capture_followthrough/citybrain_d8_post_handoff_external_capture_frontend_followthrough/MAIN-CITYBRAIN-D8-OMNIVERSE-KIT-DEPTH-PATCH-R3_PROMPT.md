...
Stage 15 of 20 in the D8 post-handoff follow-through sequence.

## Purpose

Patch Omniverse Kit depth issues: hero corridor framing, overlay labels, asset highlighting, camera path, moment callouts, capture readiness. Do not claim certified geometry or control.
...
2. Produce the stage artifact root under `outputs/main_citybrain_d8_omniverse_kit_depth_patch_r3`.
...
- `D8_OMNIVERSE_KIT_DEPTH_PATCH_R3_DECISION.json`
- `KIT_PATCH_SUMMARY.json`
- `KIT_SMOKE_REPORT.json`
- `KIT_BOUNDARY_REGRESSION.json`
- `HASH_MANIFEST.json`
