...
Stage 18 of 20 in the D8 post-handoff follow-through sequence.

## Purpose

Reconcile D8 handoff, live media pass, external validation, and front-end remediation. Fail-safe if any required real media/viewer evidence is missing unless explicitly deferred.
...
2. Produce the stage artifact root under `outputs/main_citybrain_d8_post_handoff_followthrough_integration_readiness_review`.
...
- `D8_POST_HANDOFF_FOLLOWTHROUGH_INTEGRATION_READINESS_REVIEW_DECISION.json`
- `FOLLOWTHROUGH_INPUT_ARTIFACT_INDEX.json`
- `FOLLOWTHROUGH_GAP_LEDGER.json`
- `HASH_MANIFEST.json`
