...
Stage 13 of 20 in the D8 post-handoff follow-through sequence.

## Purpose

Triage web companion and Omniverse Kit issues by P0/P1/P2. P0: boundary drift, one-truth mismatch, broken live drive, unreadable moment. No substrate work.
...
2. Produce the stage artifact root under `outputs/main_citybrain_d8_frontend_issue_triage_r1`.
...
- `D8_FRONTEND_ISSUE_TRIAGE_R1_DECISION.json`
- `FRONTEND_ISSUE_LEDGER.json`
- `FRONTEND_REMEDIATION_PLAN.json`
- `FRONTEND_PARKING_LOT.md`
- `HASH_MANIFEST.json`
